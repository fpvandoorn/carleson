...
def C2_3 (A : ℝ≥0) (τ q : ℝ) (C : ℝ≥0) : ℝ≥0 := sorry

lemma C2_3_pos (A : ℝ≥0) (τ q : ℝ) (C : ℝ≥0) : C2_3 A τ q C > 0 := sorry

def κ2_3 (A : ℝ≥0) (τ q : ℝ) (C : ℝ≥0) : ℝ := sorry

lemma κ2_3_pos (A : ℝ≥0) (τ q : ℝ) (C : ℝ≥0) : κ2_3 A τ q C > 0 := sorry

def ε2_3 (A : ℝ≥0) (τ q : ℝ) (C : ℝ≥0) : ℝ := sorry

lemma ε2_3_pos (A : ℝ≥0) (τ q : ℝ) (C : ℝ≥0) : ε2_3 A τ q C > 0 := sorry

def δ2_3 (A : ℝ≥0) (τ q : ℝ) (C : ℝ≥0) : ℝ := sorry

lemma δ2_3_pos (A : ℝ≥0) (τ : ℝ) (C : ℝ≥0) : δ2_3 A τ C > 0 := sorry

def Cψ2_3 (A : ℝ≥0) (τ q : ℝ) (C : ℝ≥0) : ℝ≥0 := sorry

lemma Cψ2_3_pos (A : ℝ≥0) (τ : ℝ) (C : ℝ≥0) : Cψ2_3 A τ C > 0 := sorry

variable {X : Type*} {A : ℝ≥0} [fact : Fact (1 ≤ A)] [IsSpaceOfHomogeneousType X A] [Inhabited X]
variable [Metric.IsRegular X A]
variable {τ q D κ ε δ : ℝ} {C₀ C t : ℝ≥0}

...
variable (p) in
theorem _root_.MeasureTheory.BoundedCompactSupport.bddAbove_norm_carlesonOn
...
theorem _root_.MeasureTheory.BoundedCompactSupport.bddAbove_norm_carlesonSum

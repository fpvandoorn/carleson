...
lemma eLorentzNorm_add_le' [SigmaFinite μ] [ContinuousAdd ε] (hf : AEStronglyMeasurable f μ)
...
lemma eLorentzNorm_add_lt_top [SigmaFinite μ] [ContinuousAdd ε] (hf : MemLorentz f p q μ)

...
\begin{lemma}[int continuous]
    ...
    \]
    is continuous in $\mfa$ for fixed $x, R_1, R_2$, right-continuous in $R_1$ for fixed $x, \vartheta, R_2$, left-continuous in $R_2$ for fixed $x, \vartheta, R_1$ and measurable in $x$ and bounded for fixed $\vartheta, R_1, R_2$.
\end{lemma}
...
\begin{proof}
    ...
    \]
    \[
        = \left| \left| \int_{R_1 < \rho(x,y) < R_2} K(x,y) f(y) e(\mfa(y) - \mfa(o)) \, \mathrm{d}\mu(y) \right| \right.
    \]
    \[
        - \left.\left| \int_{R_1 < \rho(x,y) < R_2} K(x,y) f(y) e(\mfa'(y) - \mfa'(o)) \, \mathrm{d}\mu(y) \right| \right|
    \]

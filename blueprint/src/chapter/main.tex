...
\begin{lemma}[Weak 1 1]
    ...
    Let $f:X\to\C$ be a bounded measurable function supported on a set of finite measure and assume for some $r>0$ that for every bounded measurable function $g$ on $X$ supported on a set of finite measure,
    \begin{equation}
        \label{eq-strong-2-2-assumption}
        \|H_rg\|_{2}\le 2^{a^3} \|g\|_2.
    \end{equation}
...
\begin{lemma} [Maximal theorem]
    ...
    \uses{Hardy-Littlewood}
    Let $f: X \to \C$ be bounded, measurable, supported on a set of finite measure, and let $\alpha > 0$. For $Mf$ as in \Cref{Hardy-Littlewood},
    \begin{equation}
...
\end{equation*}
With $c:=2^{-a^3-12a-4}$, this equals
\begin{equation*}
    3F(x)+\alpha/8.
\end{equation*}

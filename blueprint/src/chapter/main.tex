...
The second question of convergence bifurcates into the question of pointwise convergence
...
Thus, he had proved Luzin's conjecture \cite{MR199631}.
...
In \cite{MR340926}, C. Fefferman gave an alternative proof of Carleson's theorem via an a priori
...
Stein and Wainger \cite{MR1879821} proposed to study variants of \eqref{eq:feffermancarleson} replacing the
...
polynomials \cite{MR2545246} and the for a supremum over all polynomials in \cite{MR4125450}.
The polynomial Carleson operator was further generalized to higher dimensions and H\"older regular kernels in \cite{MR4270523}.
...
\cite{MR4460014} and maximally modulated singular Radon transforms \cite{MR4211085}, \cite{MR4687376}.

Surveys to Carleson's theorem can be found in \cite{MR2091007},\cite{MR3334208}.

In this blueprint, we prove Theorem \ref{classical Carleson} as a corollary to a further generalization of the polynomial Carleson operator towards doubling metric measure spaces, Theorem \ref{metric-space-Carleson} below,
...
Carleson type theorems on doubling metric measure spaces. This axiomatic approach is suitable for formalization and a good route towards the classical theorem.

Early drafts of the sibling communication
\cite{becker2024carlesonoperatorsdoublingmetric} existed in summer 2023. The first draft of the present blueprint was
created in the first half of 2024. In June 2024, the fourth author launched a \href{https://florisvandoorn.com/carleson/}{public website} to post the blueprint and coordinate a formalization of the complete proof in the Lean proof assistant~\cite{moura2021lean}, building on top of its mathematical library \texttt{Mathlib}~\cite{mathlib}. The formalization was completed in July 2025.
The authors of the present final version of the blueprint, each having contributed substantial amount of text to the blueprint
and/or formalized a significant number of results during the distributed formalization effort, acknowledge contributions in the form of small formalization additions, pointing out corrections to the blueprint, or supplying ideas to the
Lean efforts by the following people:
Michel Alexis,
Bolton Bailey,
Julian Berman,
Joachim Breitner,
...
L.B., F.v.D., R.S., and C.T. were funded by the Deutsche For\-schungs\-gemein\-schaft (DFG, German Research Foundation) under Germany's Excellence Strategy -- EXC-2047/1 -- 390685813.

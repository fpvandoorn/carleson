...
sets in $X$ and $k \in [-S, S]$ called dyadic cubes, the surjective projection $s\colon \mathcal{D}\to [-S, S], (I, k) \mapsto k$ to the second component
...
\eqref{eq-vol-sp-cube}, and \eqref{eq-small-boundary} hold. By abuse of notation, we will usually write just $I$ for the cube $(I,k)$, and we will write $I \subset J$ to mean that for two cubes $(I,k), (J, l) \in \mathcal{D}$ we have $I \subset J$ and $k \le l$. 

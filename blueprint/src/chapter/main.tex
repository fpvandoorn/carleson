...
\begin{lemma}[adjoint tree estimate]
    ...
    $$
    $$
        \left\| \mathbf{1}_F \sum_{\fp \in \fT(\fu)} T_{\fp}^* g\right\|_2 \le 2^{303a^3} \dens_1(\fT(\fu))^{1/2} \dens_2(\fT(\fu))^{1/2} \|g\|_2\,.
    $$
\end{lemma}
...
\begin{proof}
    ...
    noting that we may relax the condition $|f| \le \mathbf{1}_F$ to $f$ being uniformly bounded and supported on $F$ by linearity of the operators involved.
\end{proof}
...
\begin{lemma}[row bound]
    ...
    \begin{equation}
        ...
        \left\| T_{\mathfrak{R}_j}^*g \right\|_2 \le 2^{203a^3} 2^{-n/2} \|g\|_2
    \end{equation}
    and
    \begin{equation}
        \label{eq-row-bound-2}
        \left\| \mathbf{1}_F T_{\mathfrak{R}_j}^*g \right\|_2 \le 2^{304a^3} 2^{-n/2} \dens_2(\bigcup_{\fu\in \fU}\fT(\fu))^{1/2} \|g\|_2\,.
    \end{equation}
\end{lemma}

\begin{proof}
    \leanok
    Since for each $j$ the top cubes $\scI(\fu)$, $\fu \in \fU_j$ are disjoint, we have for all bounded $g$ of bounded support and $|g| \le \mathbf{1}_G$ by \Cref{adjoint-tile-support}
    $$
    ...
    $$
        \left\| \mathbf{1}_F T_{\mathfrak{R}_j}^*g \right\|_2 \le 2^{303a^3} 2^{(4a+1-n)/2} \dens_2(\bigcup_{\fu\in \fU}\fT(\fu))^{1/2} \left( \sum_{\fu \in \fU_j} \left\| \mathbf{1}_{\scI(\fu)} g\right\|_2^2 \right)^{1/2}\,.
    $$
    Again by disjointedness of the cubes $\scI(\fu)$, this is estimated by
    $$
        2^{303a^3} 2^{(4a+1-n)/2} \dens_2(\bigcup_{\fu\in \fU}\fT(\fu))^{1/2} \|g\|_2\,.
    $$
...
\begin{proof}[Proof of \Cref{forest-operator}]
    ...
    $$
        \le 2^{406a^3-n} \sum_{j = 1}^{2^n} \|\mathbf{1}_{E_j} g\|_2^2 + 2^{939a^3+1-4n}\sum_{j=1}^{2^n}\sum_{j' = 1}^{2^n} \|\mathbf{1}_{E_j} g\|_2 \|\mathbf{1}_{E_{j'}}g\|_2\,.
    $$
    ...
    $$
    $$
        \le \|f\|_2 \| \mathbf{1}_F T_{\mathfrak{R}_j}^* \mathbf{1}_G T_{\mathfrak{R}_j} f \|_2 \le 2^{304a^3-n/2} \dens_2(\bigcup_{\fu\in \fU}\fT(\fu))^{1/2} \| \mathbf{1}_G T_{\mathfrak{R}_j} f \|_2 \|f\|_2.
    $$
    ...
    $$
        \left\|\mathbf{1}_G \sum_{\fu \in \fU} \sum_{\fp \in \fT(\fu)} T_{\fp} f\right\|_2 \le 2^{304a^3} \dens_2(\bigcup_{\fu\in \fU}\fT(\fu))^{\frac{1}{2}} 2^{-\frac{n}{2}} (\sum_{j = 1}^{2^n} \|f\|_2^2)^{\frac{1}{2}}
    $$
    \begin{equation}
        \label{eq-forest-bound-2}
        = 2^{304a^3} \dens_2(\bigcup_{\fu\in \fU}\fT(\fu))^{\frac{1}{2}} \|f\|_2\,.
    \end{equation}

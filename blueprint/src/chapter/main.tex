...
\begin{proof}[Proof of \Cref{forest-operator}]
    ...
    $$
        \| \mathbf 1_G T_{\mathfrak R_j} f \|_2^2 = \left| \integral_X \overline{\mathbf 1_G T_{\mathfrak R_j} f} T_{\mathfrak R_j} f \right| = \left| \integral_X \overline{T_{\mathfrak R_j}^* \mathbf 1_G T_{\mathfrak R_j} f} \mathbf 1_F f \right|
    $$
    $$
        \le \|f\|_2 \| \mathbf 1_F T_{\mathfrak R_j}^* \mathbf 1_G T_{\mathfrak R_j} f \|_2 \le 2^{257a^3-n/2} \dens_2(\bigcup_{\fu\in \fU}\fT(\fu))^{1/2} \| \mathbf 1_G T_{\mathfrak R_j} f \|_2 \|f\|_2.
    $$
    Dividing this last inequality by the finite $\| \mathbf 1_G T_{\mathfrak R_j} f \|_2$, substituting back and taking square roots we get
    $$
        \left\|\mathbf 1_G \sum_{\fu \in \fU} \sum_{\fp \in \fT(\fu)} T_{\fp} f\right\|_2 \le 2^{257a^3} \dens_2(\bigcup_{\fu\in \fU}\fT(\fu))^{\frac{1}{2}} 2^{-\frac{n}{2}} (\sum_{j = 1}^{2^n} \|f\|_2^2)^{\frac{1}{2}}
    $$
    \begin{equation}

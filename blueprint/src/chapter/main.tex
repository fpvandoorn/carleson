...
\lean{tile_existence}
\leanok
 \uses{ball-metric-entropy,grid-existence,frequency-ball-cover}
...
\leanok
\lean{iUnion_ball_subset_iUnion_Ω₁, ball_subset_Ω₁, Ω₁_subset_ball}

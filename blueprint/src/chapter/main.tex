...
\end{equation}
Using \eqref{uniconbound} and Lemmas \ref{convergence-for-smooth}
...
\begin{equation}
    |1-e^{ix}|\ge \frac {\eta} 4
\end{equation}
\end{lemma}
\begin{proof}
\proves{lower-secant-bound}
\leanok
We have
$$
...
$$
Thus for each $x \in E$, at least one of $Th(x)$ and $T\bar h(x)$ is larger than $\frac{\epsilon}{16}$.
Thus at least one of $Th$ and $T\bar h$ is $\ge \frac{\epsilon}{16}$ on a subset $E'$ of $E$ with $2|E'| \ge |E|$. Without loss of generality this is $Th$. By assumption \eqref{eq-ffzero}, we have $|2^{2^{50}}\epsilon^{-2} h| \le \mathbf{1}_{[-\pi, 3\pi]}$. Applying \Cref{real-Carleson} with $F = [-\pi, 3\pi]$ and $G = E'$, it follows that
$$
    \frac{\epsilon}{16} |E'| \le \int_{E'} Th(x) \, dx = 2^{-2^{50}}\epsilon^2 \int_{E'} T(2^{2^{50}}\epsilon^{-2} h)(x) \, dx
$$
$$
    \le 2^{-2^{50}}  \epsilon^2 \cdot 2^{2^{40}}  |F|^{\frac{1}{2}} |E'|^{\frac{1}{2}} \le  2^{-2^{40}} \frac{\epsilon^2}{16} |E'|^{\frac{1}{2}}\,.
$$
Rearranging, we obtain
$$
    |E'| \le 2^{-2^{41}}\epsilon^2 \le \frac{\epsilon}{4}\,.
$$

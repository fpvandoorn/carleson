...
\end{equation}
\asgar{\eqref{defcnkj} gives actually the better bound $2^{-j}$ instead of $2^{1-j}$.}
\end{lemma}
...
\begin{proof}[Proof of Lemma \ref{correlation separated trees}]
    ...
    \begin{lemma}[correlation distant tree parts]
        ...
        \uses{Holder van der Corput,adjoint tile support,Holder correlation tree,lower oscillation bound}

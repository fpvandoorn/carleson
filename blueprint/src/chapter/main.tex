...
\begin{lemma}[ball metric entropy]
    ...
    $$ |\mathcal{Z}| \le 2^{ka}\,. $$
\end{lemma} % fixme: k should be `k+1`
...
\begin{lemma}[tile correlation] % fixme: no lemma inside proof environment
...
\begin{lemma}[antichain tile count] % fixme: no lemma inside proof environment

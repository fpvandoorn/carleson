...
\textit{This section is currently under construction, to incorporate the proof of \Cref{linearised-metric-Carleson}}\\
...
\begin{lemma}[Lipschitz Holder approximation]
    ...
    \leanok
    \lean{support_holderApprox_subset, dist_holderApprox_le, iLipENorm_holderApprox}

...
\begin{lemma}[tile correlation]
    ...
    \leanok
    \lean{Tile.correlation_le}
    \lean{Tile.correlation_zero_of_ne_subset}
...
\leanok
\lean{Tile.correlation}
\lean{Tile.mem_ball_of_correlation_ne_zero}
\lean{Tile.correlation_kernel_bound}

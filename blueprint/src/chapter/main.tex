...
\right|
\end{equation}
Using the bound on $K$ in \eqref{eqkernel-size} and the doublin condition \eqref{doublingx}, we estimate \eqref{firstxx'} by
\begin{align}
 \int_{r<\rho(x,y)<2r}
...
Recall that
\begin{equation*}
    H_rg(x)=\int_{r<\rho(x,y)<1} g(y) \kappa(x-y)\, dy\, .
\end{equation*}
...
\label{eqcotlar-1}
H_{r_1}(g)(x')=
\int_{r_1<\rho(x',y)<1} g(y) \kappa(x'-y)\, dy\, .
\end{equation}
On the domain $r_1<\rho(x',y)$, we have $\frac {r_1}2<\rho(x,y)$. Hence we may write
for \eqref{eqcotlar-1}
\begin{equation*}
H_{r_1}(g)(x')=\int_{r_1<\rho(x',y)<1} (g-g\mathbf{1}_{[x-\frac {r_1} 2,x+\frac {r_1}2]})(y) \kappa(x'-y)\, dy
\end{equation*}
...
\le \frac {32}{r_1}\int_{\rho(x',y)<r_1}
|g(y)|\, dy \le 64 Mg(x')\,  .
\end{equation}
...
\begin{equation}\label{eq-simple--nontangential}
    T_{r} g(x):=\sup_{r<r_1<1}\sup_{\rho(x,x')<r_1}\frac 1{2\pi} \left|\int_{r_1<\rho(x',y)<1}
g(y) \kappa(x'-y)\, dy\right|\, .
\end{equation}
\end{lemma}
\begin{proof}
...
\begin{equation}
     ...
     \frac 1{2\pi} \left|\int_{r_1<\rho(x,y)<1}
g(y) \kappa(x-y)\, dy\right|\, .
\end{equation}
...
\begin{equation}\label{eq-simpler--nontangential}
    T_{0} g(x):=\sup_{0<r_1<1}\sup_{\rho(x,x')<r_1}\frac 1{2\pi} \left|\int_{r_1<\rho(x',y)<1}
g(y) \kappa(x'-y)\, dy\right|\, .
\end{equation}
We now write by the triangle inequality
\begin{equation}\label{concretetstartriangle}
    T_* g(x)\le \sup_{0<r_1<r_2<1}\sup_{\rho(x,x')<r_1}\frac 1{2\pi} \left|\int_{r_1<\rho(x',y)<1}g(y) \kappa(x'-y)\, dy\right|
\end{equation}
    \begin{equation*}
+\sup_{0<r_1< r_2<1}\sup_{\rho(x,x')<r_1}\frac 1{2\pi} \left|\int_{r_2<\rho(x',y)<1}        g(y) \kappa(x'-y)\, dy\right|\, .
\end{equation*}
...
\begin{equation}\label{concretetstartriangle2}
   \sup_{0<r_1<1}\sup_{\rho(x,x')<r_1}\frac 1{2\pi} \left|\int_{r_1<\rho(x',y)<1}g(y) \kappa(x'-y)\, dy\right|
\end{equation}
    \begin{equation*}
+\sup_{0< r_2<1}\sup_{\rho(x,x')<r_2}\frac 1{2\pi} \left|\int_{r_2<\rho(x',y)<1}        g(y) \kappa(x'-y)\, dy\right|\, .
\end{equation*}

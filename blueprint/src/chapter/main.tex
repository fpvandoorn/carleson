...
The first draft of the present blueprint was created in the first half of 2024.
In June 2024, the fourth author launched a \href{https://florisvandoorn.com/carleson/}{public website}
to post the blueprint and coordinate a formalization of the complete proof in the Lean proof assistant~\cite{moura2021lean},
building on top of its mathematical library \texttt{Mathlib}~\cite{mathlib}.
The formalization was performed in % todo

The formalization was completed in July 2025.
...
% and/or formalized a significant number of results during the distributed formalization effort.
We also acknowledge contributions in the form of small formalization additions, pointing out corrections to the blueprint, or supplying ideas to the
...
\section{Statement of the metric space Carleson theorems}

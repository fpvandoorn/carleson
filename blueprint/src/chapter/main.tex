...
\begin{proof}[Proof of \Cref{forest-operator}]
    ...
    $$
        \| \mathbf{1}_G T_{\mathfrak{R}_j} f \|_2^2 = \left| \integral_X \overline{\mathbf{1}_G T_{\mathfrak{R}_j} f} T_{\mathfrak{R}_j} f \right| = \left| \integral_X \overline{T_{\mathfrak{R}_j}^* \mathbf{1}_G T_{\mathfrak{R}_j} f} \mathbf{1}_F f \right|
    $$
    $$

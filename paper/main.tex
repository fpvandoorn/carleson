...
These three branches of the proof are largely independent and handled in separate sections of the blueprint and formalization. %include reference? define the 'types' explicitly?

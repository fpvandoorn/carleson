...
This was incorrectly assumed in the first version of the blueprint,
and we fixed this by defining the right inequality on cubes as $I \le J$ iff $I \subseteq J$ and $s(I) \le s(J)$.
In the blueprint we kept using the notation ``$I \subset J$'' for this inequality,

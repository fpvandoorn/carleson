...
Formalizing the metric Carleson theorem required us to formalize foundational results from harmonic analysis, which we are upstreaming to \mathlib and which will be useful for the formalization of other results from this field. Future project will also benefit from some of the insights we learned during the project, including the creation of extended norms and our reflections about the most convenient ways to work with real number types.

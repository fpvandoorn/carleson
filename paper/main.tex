...
Specific choices of the objects and structures involved are leveraged to derive the classical Carleson theorem.
...
For two-sided alder\'on--Zygmund kernels, the additional regularity allows us to weaken one of the assumptions to the family of operators $T_r$, which is easier to work with in applications.

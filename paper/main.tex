...
Large formalization projects have been undertaken in different proof assistants and various areas.
Notable formalization projects in analysis include Immler's verification of the singular hyperbolicity of the Lorentz attractor \cite{ImmlerLorentzSolver} (in Isabelle/HOL),
Immler and Tan's formalization of the Poincaré-Bendixon theorem \cite{ImmlerTanPoincareBendixon} (in Isabelle/HOL), % xxx noteworthy enough? ~7000 LoC

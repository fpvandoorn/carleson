...
The metric space Carleson theorem in \cite{CarlesonBlueprint} is a restricted weak type estimate for a generalized Carleson operator.
...
where $C_{4,2}$ is a constant independent of $F$, $G$, and $f$ and
\begin{equation}
...
Let $a \ge 4$ be a natural number. As mentioned before, a doubling metric measure space $(X,\rho,\mu, a)$ is a complete and locally compact metric space $(X,\rho)$

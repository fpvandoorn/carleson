...
\end{equation*}
The Lean version \lean{fourierCoeffOn}\hyperref{https://github.com/leanprover-community/mathlib4/blob/44ea3a0e13339f31231dde209c4f8196e179065d/Mathlib/Analysis/Fourier/AddCircle.lean#L351-L355}{\extlink} uses \mathlib's formalization of the Bochner integral and thus is well-defined if $f\in L^1(0,2\pi)$.

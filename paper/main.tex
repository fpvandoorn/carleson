% compile with xelatex or with pdflatex -shell-escape
...
The planning of the Carleson project started in Fall 2023 by
...
applying it to the maximal functions requires a version which applies to functions with codomain $[0, \infty]$ (or, more generally, any commutative monoid with a compatible enorm).
...
we have formalized a more general argument that is also conceptually clearer: for instance, it demonstrates that the subtractive structure on the codomain is not used in a meaningful way.

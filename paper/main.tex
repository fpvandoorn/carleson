...
} % TODO: configure support for rendering ≠
...
These tactics do not work for terms in $\ennreal$ or $\nnreal$.\footnote{Since February 2026, \texttt{linarith} also supports $\nnreal$: this change was made after the completion of this project.}

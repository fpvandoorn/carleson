...
In this article, we focus on a generalization of Carleson's theorem to the setting of doubling metric measure spaces, proven in \cite{ThieleCarlesonPreprint}.
...
such as the Polynomial Freiman--Rusza project~\cite{gowers2023conjecturemarton},
the Sphere eversion project~\cite{massot2022sphereeversion},
the PNT$+$ project\footnote{\url{https://alexkontorovich.github.io/PrimeNumberTheoremAnd/}}

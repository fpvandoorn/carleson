...
Future project will also benefit from some of the insights we learned during the project,
...
we would instead use the existing GitHub issue infrastructure (as is done for instance in the PNT project).
Zulip would still be used as a discussion platform,
and in particular to discuss potential errors within the blueprint proofs.
...
since this ended up causing most of the mathematical errors in the first version of the blueprint.

...
\end{equation*}
The Lean version \lean{fourierCoeffOn}\href{https://github.com/leanprover-community/mathlib4/blob/44ea3a0e13339f31231dde209c4f8196e179065d/Mathlib/Analysis/Fourier/AddCircle.lean#L351-L355}{\extlink} uses \mathlib's formalization of the Bochner integral and thus is well-defined if $f\in L^1(0,2\pi)$.

\begin{definition}\label{def:fourier-series}
The \emph{$N$-th partial Fourier sum} of $f$ for $x\in\real$ is defined as
...
For the formal proof, we changed the definition to allow arbitrary suprema: this means the maximal function is $[0,\infty]$-valued.
(Our definition also extends to a far broader class than functions $\complex\to\real^d$. Initially, we allowed any function $X\to E$ from a pseudo-metric space $X$ with a measure, to a normed abelian additive group $E$.
The final form\href{https://github.com/fpvandoorn/carleson/blob/696c07687a9c26c87c8a1d36b16da3775d9d11e8/Carleson/ToMathlib/HardyLittlewood.lean#L32}{\extlink}
allows $E$ to be any space with an extended norm, requiring no additive structure.)
...
Finally, there were several results in the project that required us to consider sets of elements from a given finite type $\texttt{T}$. Since all such sets are finite, from a mathematical point of view there is no difference between the types $\texttt{Set T}$\href{https://github.com/leanprover-community/mathlib4/blob/44ea3a0e13339f31231dde209c4f8196e179065d/Mathlib/Data/Set/Defs.lean#L44-L51}{\extlink} and $\texttt{Finset T}$\href{https://github.com/leanprover-community/mathlib4/blob/44ea3a0e13339f31231dde209c4f8196e179065d/Mathlib/Data/Finset/Defs.lean#L72-L79}{\extlink}.

...
In particular, \Cref{metric-space-Carleson} is strong enough to prove stronger versions of the \Cref{classical-carleson}. In particular, the assumption in \Cref{classical-carleson} that $f$ is continuous can be weakened to the statement that $f$ is $L^p$ for $p>1$. TODO
